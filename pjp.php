...
<head>
    ...
    <meta name="theme-color" content="#ca520cff">
    <meta name="viewport" content="width=device-width, initial-scale=0.60, shrink-to-fit=no">
    <title>PJP Team In Here !!!</title>
...
.border {
    box-shadow: 0px 0px 10px #ca520cff;
...
.border:hover {
    box-shadow: 0px 0px 10px #ca520cff;
    border: 2px solid #ca520cff!important;
}

.table td {
    padding: 0.1rem;
    box-shadow: inset 0px 0px 0px 1px #ca520cff;
    border-radius: 2px;
}

.table thead th {
    font-family: 'Amaranth', cursive;
    box-shadow: inset 0px 0px 0px 1.5px #ca520cff;
    color:#ffffff;
    padding: 0.25rem;
    border-radius: 5px;
...
<a href="?" style="font-size: 1.5rem;padding: 0.5rem;"><span class="rainbow-text" style="font-family:Rock Salt">PJP Team in Here !!</span></a>
</div>
